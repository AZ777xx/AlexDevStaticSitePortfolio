# NeurocoderTestEnv
### Python+Streamlit.io+ChatGPTApi
![Веб-сайт Streamlit.io, Интерфейс для сравнения моделей](img/Projects/NeuroCoderTestEnv.PNG)

*Набор скрпитов и интерфейса для до-обучения и сравнения разных подходов в специализации LLM*

- Веб-сайт на [Streamlit.io](https://streamlit.io/) для интерактивного сравнения моделей, поддерживает загрузку моделей с минимальным согласованием по коду
- Веб-сайт с возможностью интерактивного выбора параметров для ChatGPT (Температура, токены итд.) и настройки параметров LlamaIndex
- Скрипты автоматического составления training-data и fine-tuning по файлам в папке (Запросы к ChatGPT по метаданным, составление промпта для получения пар Q/A под каждый файл)
- Скрипты автоматического составления и выбора параметров для [LlamaIndex](https://www.llamaindex.ai/)
----------
# WBArticleChecker
### Python+Selenium
![WBArticleChecker, главное окно](img/Projects/WBArticleChecker.PNG)

*Автоматизация поиска товаров, представленных дешевле у конкурентов*

- Разработана для продавца Wildberries
- Поддерживает загрузку артиклей и товаров как с WB, так и с Ексель и других форматов
- Проверяет, есть ли у конкурентов цены ниже на артикли из "нашего" магазина
- Возможность выгрузки списка найденных артикулей / товаров в разных форматах
----------
# LoveplanetBot
### Python+Реверс Api
![Автолайкер, главное окно](img/Projects/LovePlanetBot.PNG)
![Автоотправка сообщений](img/Projects/LovePlanetBot2.PNG)

*Автоматизация работы с сайтом знакомств Loveplanet.ru*

- Разработана для компании, работающей с сайтами знакомств
- Был найден и адаптирован для программной работы внутренний API Loveplanet
- Автоматизация поиска и "лайканья" страниц
- Автоматизация рассылки сообщений, поддерживаются разные критерии отправки
- Возможность выгрузки списка пользователей из "общих лайков"
- Поддержка автоматической и ручной разгадки каптчи
----------
# TwitchMultiAccChat
### Python+Flask+IRC
